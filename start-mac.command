...
# LiveKit Security+ Agent - One Click Start (Mac)
# ===============================================
...
# Start vision agent with interactive content
echo "🤖 Starting Security+ Vision Agent with Interactive Exercises..."
...
echo "   • 'List interactive exercises' - See all hands-on activities"
echo "   • 'Start network exercise' - Draw secure network topologies"
echo "   • 'Give me a cipher challenge' - Decrypt secret messages"
echo "   • 'Start incident response' - Design security response plans"
echo "   • 'Can you see my screen?' - Test vision capability"
echo "   • 'Analyze my screen' - Screen analysis and feedback"
echo ""
echo "📝 Logs:"
